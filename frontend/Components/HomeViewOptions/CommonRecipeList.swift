        ...
        ZStack(alignment: .top) {
            ScrollView {
                VStack(spacing: 16) {
                    ...
                    CommonRecipeView(
                        recipe: .switchRecipe(BaseRecipe<SwitchInfo>.COFFEE_CHRONICLER_RECIPE),
                    ...
                    CommonRecipeView(
                        recipe: .switchRecipe(BaseRecipe<SwitchInfo>.SPROMETHEUS_RECIPE),
                    ...
                    CommonRecipeView(
                        recipe: .v60Recipe(BaseRecipe<V60Info>.JAMES_HOFFMAN_RECIPE),
                    ...
                    CommonRecipeView(
                        recipe: .v60Recipe(BaseRecipe<V60Info>.FOURTOSIX_RECIPE),
                    ...
                    CommonRecipeView(
                        recipe: .v60Recipe(BaseRecipe<V60Info>.FIVE_POUR_METHOD),
                    ...
                    CommonRecipeView(
                        recipe: .v60Recipe(BaseRecipe<V60Info>.LANCE_HEDRICK_PREFERRED),
                    ...
                    CommonRecipeView(
                        recipe: .v60Recipe(BaseRecipe<V60Info>.LANCE_HEDRICK_HIGH_EXTRACTION),
